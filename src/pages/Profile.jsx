                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="mt-8 w-full max-w-md space-y-4">
                        <button
                            ...
                            disabled={uploading}
                            className="w-full py-3 px-4 rounded-xl bg-[#00f6ff]/10 hover:bg-[#00f6ff]/20 border border-[#00f6ff]/30 text-[#00f6ff] font-medium transition-all flex items-center justify-center gap-2"
                        >
