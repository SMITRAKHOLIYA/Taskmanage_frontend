    ...
    return (
        ...
        >
            <div className="h-full flex flex-col justify-between bg-white dark:bg-gray-900">
                ...
                <div className="px-3 py-4 overflow-y-auto custom-scrollbar flex-1">
                    <div className="flex items-center justify-between mb-6 pl-2.5">
                        <Link to="/dashboard" className="flex items-center gap-3 no-underline">
                            ...
                            <span className="self-center text-xl font-bold whitespace-nowrap dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300">
                                TaskMaster
                            </span>
                        </Link>
                        {/* Mobile Close Button */}
                    ...
                    {user && (
                        <div className="mb-6 mx-1 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-700/50" onClick={() => navigate('/profile')}>
                        ...
                        {navLinks.filter(link => link.visible).map(link => (
                            <li key={link.to}>
                                <NavLink
                                    ...
                                    onClick={() => setIsOpen(false)}
                                >
                                    <span className={({ isActive }) => isActive ? 'text-primary-600 dark:text-primary-400' : 'text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white'}>
                                        {link.icon}
                                    </span>
                ...
                <div className="border-t border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-black/20">
                    <div className="flex items-center justify-around p-3">
                        <ThemeToggle positionClass="bottom-full left-0 mb-2 origin-bottom-left" />
                        ...
                        <div className="relative" ref={notificationRef}>
                            ...
                            {showNotifications && (
                                <NotificationPanel
                                    ...
                                    positionClass="fixed bottom-20 left-4 right-4 z-50 origin-bottom w-auto md:absolute md:left-full md:bottom-0 md:ml-4 md:w-96 md:origin-bottom-left"
                                />
                            )}
                        </div>
